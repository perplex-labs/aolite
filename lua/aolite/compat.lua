    ...
    if searchPath then
        ...
        if not file then
            error("Failed to open file: " ..
                searchPath ..
                " (" ..
                (err_open or "unknown error") .. ") for module " .. moduleName .. " (resolved to " .. resolvedPath .. ")")
        end
        ...
        if not chunk then
            error("Failed to load chunk from " ..
                searchPath ..
                " for module " ..
                moduleName .. " (resolved to " .. resolvedPath .. "): " .. (err_load or "unknown error"))
        end

        return chunk()
    else
        error("Module '" ..
            moduleName .. "' (resolved to '" .. resolvedPath .. "') not found in package.path using loadfile approach.")
    end
end
